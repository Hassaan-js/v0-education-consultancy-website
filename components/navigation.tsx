  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/92 backdrop-blur-2xl border-b border-border/40 shadow-lg"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 md:h-24">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              <span className="font-bold text-foreground text-base tracking-tight">Express Consultancy</span>
          ...
          <div className="hidden md:flex items-center gap-3 lg:gap-4">
            <a
              ...
              className="flex items-center gap-2 text-secondary hover:text-primary transition-colors text-sm font-semibold group px-4 py-2.5 rounded-full hover:bg-secondary/10"
            >
              <MessageCircle size={18} className="group-hover:scale-125 transition-transform duration-300" />
              <span>WhatsApp</span>
            </a>
            <a
            ...
            >
              ...
              <span className="hidden lg:inline">+44 7871 820508</span>
            </a>
            <button className="button-primary shadow-lg text-sm font-semibold">Free Consultation</button>
          </div>
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden pb-8 border-t border-border/40 bg-white/50 backdrop-blur-md animate-in fade-in slide-in-from-top-4 duration-300">
            <div className="space-y-1 py-4">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="block py-3 px-4 text-foreground/80 hover:text-primary hover:bg-primary/5 transition-all text-sm font-medium rounded-lg"
            ...
            <div className="px-4 py-4 space-y-3 border-t border-border/40 mt-4">
              ...
              <button className="button-primary w-full">Free Consultation</button>
            </div>
          </div>
        )}
      </div>
