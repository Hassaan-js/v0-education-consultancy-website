        ...
        <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
            <button
              ...
              className="bg-white hover:bg-gray-50 text-secondary px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-[1.02] active:scale-95 text-lg"
            >
            ...
            <button
              ...
              className="border-2 border-white text-white hover:bg-white/10 backdrop-blur-sm px-8 py-4 rounded-full font-bold transition-all duration-300 text-lg"
            >
              Explore Services
            </button>
          </div>
