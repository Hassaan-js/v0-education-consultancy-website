...
export default function HeroEnhanced() {
  ...
  return (
    <section className="relative overflow-hidden pt-24 sm:pt-28 md:pt-32 pb-20 sm:pb-24 md:pb-32 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
          ...
          >
            <div className="space-y-6 lg:space-y-8">
              <div className="inline-block">
                <div className="flex items-center gap-2 bg-gradient-to-r from-primary/10 to-secondary/10 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full border border-primary/20 hover:border-primary/40 transition-all duration-300 backdrop-blur-sm">
                  ...
                  <p className="text-primary font-bold text-xs tracking-widest uppercase">Your UK Education Gateway</p>
                </div>
              </div>

              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-foreground leading-tight text-balance premium-heading">
                Your Pathway to Global Education Starts Here
              </h1>

              <p className="text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed text-balance max-w-2xl font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 lg:pt-6">
              <button className="button-primary flex items-center justify-center gap-3 group text-sm sm:text-base w-full sm:w-auto">
                Book Free Consultation
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform duration-300" />
              </button>
              <button className="button-outline flex items-center justify-center gap-3 group text-sm sm:text-base w-full sm:w-auto">
                Apply Now
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform duration-300" />
              </button>
            </div>
